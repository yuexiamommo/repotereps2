package cn.itcast.mr.weblog.visits;
...
//		FileInputFormat.setInputPaths(job, new Path("D:\\weblog\\pageviews2"));
//		FileOutputFormat.setOutputPath(job, new Path("D:\\weblog\\vists"));
