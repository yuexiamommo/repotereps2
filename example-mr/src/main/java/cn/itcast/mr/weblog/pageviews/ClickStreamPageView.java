package cn.itcast.mr.weblog.pageviews;
...
public class ClickStreamPageView {
	...
	static class ClickStreamReducer extends Reducer<Text, WebLogBean, NullWritable, Text> {
		...
		protected void reduce(Text key, Iterable<WebLogBean> values, Context context) throws IOException, InterruptedException {
			...
			//todo 遍历迭代器 把数据添加到集合中
//			for (WebLogBean value : values) {
//				System.out.println(value);
//				beans.add(value); //todo  这里有深坑 及其的深
//			}
...
//		FileOutputFormat.setOutputPath(job, new Path("D:\\weblog\\pageviews2"));
