...
import cn.itcast.mr.ordercounttop1.OrderGrouping;
 ...
 */
public class OrderCountTopClient {
    public static void main(String[] args) throws Exception{
        ...
        //指定mr程序运行的主类
        job.setJarByClass(OrderCountTopClient.class);

        //指定mr程序的mapper reducer类
        job.setMapperClass(OrderCountTopMapper.class);
        job.setReducerClass(OrderCountTopReducer.class);
        ...
        FileOutputFormat.setOutputPath(job,new Path("D:\\GroupingComparator\\output7"));
